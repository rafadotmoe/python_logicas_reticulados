...
def output_latex(proof, seq):
    ...
    proof_data = nl.lift_object_to_bussproofs(proof)
    formula_left = nl.lift_formula_to_latex_string(seq[0])
    formula_right = nl.lift_formula_to_latex_string(seq[1])
